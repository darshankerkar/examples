...
import (
	...
	"github.com/kubeedge/examples/predictive-maintenance/mapper/pkg/config"
	"github.com/kubeedge/examples/predictive-maintenance/mapper/pkg/driver"
	"github.com/kubeedge/examples/predictive-maintenance/mapper/pkg/dmi"
	"github.com/kubeedge/examples/predictive-maintenance/mapper/pkg/inference"
)
